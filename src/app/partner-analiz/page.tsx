...
const initialFeatures: Feature[] = [
  ...
  { id: 27, name: 'Centilmenlik', level: 7 },
];
...
export default function PartnerAnalizPage() {
  ...
  const downloadChart = async () => {
    ...
    if (!pngBlob) {
      showToast('Grafik indirilemedi');
      return;
    }

    const filename = 'partner-bass-grafigi.png';
